...
st.logo('logo.svg')
st.error('Toto je pracovní verze. Data s vyjímkou budoucího růstu pochází z CEPII databáze BACI. Projekce 2025-30 berte s velikou rezervou, mimo jiné totiž neberou v potaz inflaci.', icon="⚠️")
